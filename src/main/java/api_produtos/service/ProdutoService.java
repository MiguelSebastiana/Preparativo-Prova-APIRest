package api_produtos.service;

import api_produtos.dto.ProdutoCreateRequest;
import api_produtos.dto.ProdutoResponse;
import api_produtos.dto.ProdutoUpdateRequest;
import api_produtos.entity.Produto;
import api_produtos.exception.ProdutoNaoEncontradoException;
import api_produtos.mapper.ProdutoMapper;
...
public class ProdutoService {
    ...
    public ProdutoResponse buscarPorId(Long id) {
        return repository.findById(id)
                ...
                .orElseThrow(() -> new ProdutoNaoEncontradoException("Produto nao encontrado para id: " + id));
    }
    ...
    public ProdutoResponse atualizar(Long id, ProdutoUpdateRequest request){
        Produto produto = repository.findById(id)
                .orElseThrow(() -> new ProdutoNaoEncontradoException("Produto não cadastrado com esse id: " + id));
    ...
    public void remover(Long id){
        Produto produto = repository.findById(id)
                .orElseThrow(() -> new ProdutoNaoEncontradoException("Produto nao encontrado com o id: " + id));
